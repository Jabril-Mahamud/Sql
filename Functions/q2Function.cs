...
{
    private readonly ILogger<q2Function> _logger;

    private readonly ITtsService _ttsService;
    private readonly IBlobStorageService _blobStorageService;

    public q2Function(ILogger<q2Function> logger, ITtsService ttsService, IBlobStorageService blobStorageService)
    {
        _logger = logger;
    ...
    [Function(nameof(q2Function))]
    public async Task RunAsync([QueueTrigger("myqueue-items", Connection = "Qstring")] QueueMessage message)
    {
